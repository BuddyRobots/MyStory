...
public class Pendulum2D : MonoBehaviour {
    ...
    /// <summary>
    /// 处理initialAngle改变时的一些参数变化,包括index,expectantAngle,recordPoints
    /// </summary>
    //void Handle(out int _index, out float _expectantAngle, List<float> _recordPoints)
    //{
