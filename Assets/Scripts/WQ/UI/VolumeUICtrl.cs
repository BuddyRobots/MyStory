...
public class VolumeUICtrl : MonoBehaviour {
	...
	void Start () 
	{
		...
		volumeImage_0=Resources.Load<Sprite>("Pictures/Volume/VolumeGrey");
		volumeImage_1=Resources.Load<Sprite>("Pictures/Volume/Volume_1");
		volumeImage_2=Resources.Load<Sprite>("Pictures/Volume/Volume_2");
		volumeImage_3=Resources.Load<Sprite>("Pictures/Volume/Volume_3");
		volumeImage_4=Resources.Load<Sprite>("Pictures/Volume/Volume_4");
	}
