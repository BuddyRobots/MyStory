...
public class SubtitleFadeInAndOutTest : MonoBehaviour 
{
...
//
	...
	void FadeOut()
	{
		subtitleText.CrossFadeAlpha(0,SUBTITLE_FADINGTIME,true);
	}

	void FadeIn()
	{
		
		subtitleText.CrossFadeAlpha(1,SUBTITLE_FADINGTIME,true);
	}
